...
class PressPlate : Tile
{
    ...
    public PressPlate(RoomNew room, ContentManager Content, Enumeration.TileType tileType, Enumeration.StateTile state, int switchButton, Enumeration.TileType NextTileType__1)
    {
        base.room = room;
