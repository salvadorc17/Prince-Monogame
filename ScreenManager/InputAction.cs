...
namespace PrinceGame
{
    ...
    public class InputAction
    {
        ...
        private delegate bool ButtonPress(Buttons button, System.Nullable<PlayerIndex> controllingPlayer, ref PlayerIndex player);
        private delegate bool KeyPress(Keys key, System.Nullable<PlayerIndex> controllingPlayer, ref PlayerIndex player);
